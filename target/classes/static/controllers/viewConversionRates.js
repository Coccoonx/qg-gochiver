angular
		...
		.controller(
				...
				function($scope, $http, $interval, uiGridConstants, $location,
					...
					$scope.getAllConversionRates = function() {
					...
					$scope.getAllConversionRates();
					
					$scope.gridOptions.columnDefs = [ {
						name : 'conversionRate.id',
						displayName : 'Rate Id',
						enableHiding : false,
						enableCellEdit : true
						...
						name : 'conversionRate.company',
						enableHiding : false,
						displayName : 'Company',
						enableCellEdit : true
					}, {
						name : 'conversionRate.sourceCurrency',
						enableHiding : false,
						displayName : 'Source Currency',
						enableCellEdit : true,

					}, {
						name : 'conversionRate.targetCurrency',
						enableHiding : false,
						displayName : 'Target Currency',
						enableCellEdit : true,

					},{
						name : 'conversionRate.rate',
						enableHiding : false,
						displayName : 'Rate',
						enableCellEdit : true,
						filters: [
					...
					$scope.addConversionRate = function() {
						$location.path('/addConversionRate');
					}
					
					$scope.deleteConversionRate = function() {
						
						var row = $scope.gridApi.selection.getSelectedRows();
						$localStorage.rateId = row[0].conversionRate.id;
						console.log($localStorage.rateId);
						
						swal(
								{
									title : "<b> Delete Conversion Rate </b>",
									text : "Would you like to delete this rate?",
										...
										$http(
												{
													...
													params :  {
														id : $localStorage.rateId
												}
												}).success(function (response){
													console.log("Rate deleted sucessfully");
									       			$auth.setToken($localStorage.token);
									       			swal("Success!",
